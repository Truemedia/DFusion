...
<a href="index.php?option=com_jfusion&task=syncmaster"><img src="<?php echo 'components/com_jfusion/images/syncmaster.png'; ?>" height="75px" width="75px"></a>
</td><td>
<a href="index.php?option=com_jfusion&task=syncmaster"><?php echo JText::_('SYNC_MASTER_INSTR');?></a>
</td></tr></table></br>

<table class="adminform"><tr><td>
<a href="index.php?option=com_jfusion&task=syncslave"><img src="<?php echo 'components/com_jfusion/images/syncslave.png'; ?>" height="75px" width="75px"></a>
</td><td>
<a href="index.php?option=com_jfusion&task=syncslave"><?php echo JText::_('SYNC_SLAVE_INSTR');?></a>
</td></tr></table></br>

<table class="adminform"><tr><td>
<a href="index.php?option=com_jfusion&task=synchistory"><img src="<?php echo 'components/com_jfusion/images/synchistory.png'; ?>" height="75px" width="75px"></a>
</td><td>
